...
class App extends Component {
  constructor(props) {
    ...
    this.eventUrl = 'https://www.facebook.com/events/1067152256955116/';
      ...
      <div className="App">
        ...
        <div className="section section-one">
          ...
          */}
          ...
          {/*
          <div className="joinUs">Stay tuned for future popups</div>
          */}
          <a className="button" href={this.typeformUrl} target="_blank" rel="noopener noreferrer">Become a Vendor</a> 
          <a className="button" href={this.eventUrl} target="_blank" rel="noopener noreferrer">Next event</a> 
          {/*
            <a className="button" href={this.typeformUrl} target="_blank" rel="noopener noreferrer">Become a Vendor</a> 
          */}
        </div>
